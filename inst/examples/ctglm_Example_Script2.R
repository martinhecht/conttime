...
# Daten
load( file.path( user.profile, "Dropbox/139_conttime/conttime/inst/datafiles/P005J000005O062r0001.Rdata" ) )
...
# Modell definieren
m <- ctglm.model( engine="jags", d=L, person.var=c("b"=TRUE,"mu.t1"=TRUE), track.person.par=c("bj","mu.t1.j"), measurement.model=gaussian() )
